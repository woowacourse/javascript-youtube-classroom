...
- [x] 이후 페이지를 방문했을 때 기본 메인 화면은 내가 **시청 중인** 영상 들의 리스트를 보여준다.
...
- [x] 사용자가 버튼을 클릭했을 때 해당 행위가 정상적으로 동작하거나, 실패하였음을 `snackbar`를 통해 보여준다.
  - [x] **시청 중인** 영상에서 **시청 완료** 영상으로 체크하면 '영상이 **시청 완료** 영상으로 이동되었습니다.'
  - [x] **시청 완료** 영상에서 **시청 중인** 영상으로 체크하면 '영상이 **시청 중인** 영상으로 이동되었습니다.'
  - [x] 삭제버튼을 클릭하면 '영상 삭제가 완료되었습니다.'
  - [x] 요청 작업 실패시 '요청하신 작업을 수행할 수 없습니다. 문제가 지속적으로 발생되면 관리자에게 문의해주세요.'
- [x] 시청 중인 영상, 시청 완료 영상 메뉴버튼을 눌러 필터링할 수 있다.
