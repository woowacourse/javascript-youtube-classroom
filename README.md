...
- [ ] 처음 페이지를 방문 할 때에는 기본화면으로 볼 영상 화면을 먼저 보여준다
- [ ] 볼 영상 nav 버튼을 누르면 볼 영상 화면으로 이동한다
- [ ] 볼 영상에서의 보여지는 영상 리스트는 localStorage에 저장된 영상들로 한다
...
- [ ] 본 영상 nav 버튼을 누르면 본 영상 화면으로 이동한다
...
- [ ] 검색 nav 버튼을 누르면 검색 모달이 화면에 나타난다

### 반응형 웹 만들기

- [ ] 화면의 크기에 따라 화면 상에 보여지는 동영상의 개수를 다르게 한다
