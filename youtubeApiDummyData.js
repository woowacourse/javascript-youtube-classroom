  ...
  items: [
    {
      ...
      snippet: {
        ...
        description:
          '2022년 2월에서 11월까지 10개월 과정으로 진행하는 우아한테크코스 4기에 대한 설명회이다. 설명회는 우아한테크코스 교육 ...',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          '우테코로그 Ep.4 그루밍의 하루 ☀️ 돌아온 우테코 vlog의 첫 번째 주자는 3기 크루 중 가장 밝은 텐션을 자랑하는 그루밍입니다 : ) 잘 ...',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          '우아한테크코스 후기를 기록한 영상입니다. 이 영상에서는 우아한테크코스의 선발과정에 대하여 다룹니다. 1편 우아한테크코스 2기?',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          "우아한테크코스의 크루들이 진행하는 인터뷰 챌린지입니다.   이번 우테코 인터뷰 챌린지는 '코치 인터뷰'로 진행되었습니다.",
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          '우테코로그 Ep.5 우테코 프로젝트 비하인드 이번 우테코로그는 현재 크루들이 진행하고 있는 프로젝트 선정 비하인드 영상입니다 ...',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          '우아한테크코스의 크루들이 진행하는 인터뷰 챌린지입니다.   우테코 인터뷰 챌린지 이번 편은 백엔드와 프론트엔드 크루들이 평소에 ...',
        thumbnails: {
          default: {
    ...
    {
      kind: 'youtube#searchResult',
      etag: '-vJ1egJvXGADhkDksEqQJZsnGiw',
      id: {
        kind: 'youtube#video',
        videoId: 'tpdrVhMEqMQ',
      },
      snippet: {
        publishedAt: '2020-12-10T02:52:06Z',
        channelId: 'UC-mOekGSesms0agFntnQang',
        title: '[우테코 🎬vlog] 우아한테크코스 마무리 이야기 #2',
        description:
          '11월 27일, 우아한테크코스 2기가 마무리되었습니다. 지난 10개월 동안 꿈을 향해 정말 열심히 달린 크루들이 우테코를 돌아보며 ...',
        thumbnails: {
          default: {
            url: 'https://i.ytimg.com/vi/tpdrVhMEqMQ/default.jpg',
            width: 120,
            height: 90,
          },
          medium: {
            url: 'https://i.ytimg.com/vi/tpdrVhMEqMQ/mqdefault.jpg',
            width: 320,
            height: 180,
          },
          high: {
            url: 'https://i.ytimg.com/vi/tpdrVhMEqMQ/hqdefault.jpg',
            width: 480,
            height: 360,
          },
        },
        channelTitle: '우아한Tech',
        liveBroadcastContent: 'none',
        publishTime: '2020-12-10T02:52:06Z',
      },
    },
    {
      kind: 'youtube#searchResult',
...
export default youtubeApiDummyData;
