...
export const $saveButton = $('.video-item__save-button', $modal);
...
export const $checkButton = $('#check-button', $mainVideoList);
export const $deleteButton = $('#delete-button', $mainVideoList);
