...
describe('Storage 기능 테스트', () => {
  ...
  it('localStorage에 저장되지 않은 영상에 대해 업데이트를 시도하면 에러를 던진다.', () => {
  ...
  it('localStorage에 저장된 영상 정보를 업데이트 할 수 있다.', () => {
